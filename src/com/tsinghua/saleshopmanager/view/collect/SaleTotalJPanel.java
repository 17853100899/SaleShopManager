...
public class SaleTotalJPanel extends javax.swing.JPanel implements ActionListener {
	...
	public static void main(String[] args) {
		...
		frame.getContentPane().add(new SaleTotalJPanel());
		frame.setDefaultCloseOperation(WindowConstants.DISPOSE_ON_CLOSE);
		frame.pack();
		frame.setVisible(true);
	}

	public SaleTotalJPanel() {
		super();
		initGUI();
	}
	...
	private void initGUI() {
		try {
			...
			this.setLayout(null);
			{
				...
				{
					jPanel1 = new JPanel();
					jTabbedPane1.addTab("销售明细查询", null, jPanel1, null);
					...
					}
					{
						...
						jScrollPane1.setBounds(5, 90, 666, 201);
						{
							...
							tableModel.setDataVector(toTalDAO.getSaleWare(), toTalDAO.getSaleColoumn());
							jTable1 = new JTable();
				...
				{
					jPanel2 = new JPanel();
					jTabbedPane1.addTab("销售汇总查询", null, jPanel2, null);
					...
					}
					{
						...
						jScrollPane2.setBounds(0, 83, 676, 201);
						{
							...
							tableModel2.setDataVector(toTalDAO.getSaletotal("2010-12-12", "2012-12-31"),
									toTalDAO.getSaleTotalColoumn());
							jTable2 = new JTable();
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == jButton1) {
			...
			tableModel.setDataVector(toTalDAO.getSaleWare(start, end), toTalDAO.getSaleColoumn());
		...
		if (e.getSource() == jButton2) {
			...
			tableModel2.setDataVector(toTalDAO.getSaletotal(start, end), toTalDAO.getSaleTotalColoumn());
